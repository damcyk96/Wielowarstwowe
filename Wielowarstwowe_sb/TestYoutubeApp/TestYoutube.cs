...
namespace TestYoutubeApp
{
    ...
    public class TestYoutube
    {
        ...
        //    Assert.IsInstanceOfType(vResult.Model, typeof(List<Video>));
        //}
        ...
        //    Assert.IsTrue((vResult.Model as List<Video>).Count > 1);
        //}
        ...
        public void TestControllertReturnFiveVideosMockVideoService()
        {
            ...
            //mockService.Setup(s => s.GetVideos(It.IsAny<string>())).Returns(() =>
            ...
            //TODO: 
            //mockService.Setup(s => s.GetVideos(It.IsAny<string>()))
            //    .Returns(() => new Task<Video.Model.Video>(() =>
            //        new List<Video.Model.Video>
            //    {
            //        new Video.Model.Video(),
            //        new Video.Model.Video(),
